...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Sketch', 'year'), ['() -> int']),
    (('Sketch', 'launch_thread'), ['(f: Callable, name: str, args: Tuple, kwargs: Dict) -> str']),
    (('Sketch', 'launch_promise_thread'), ['(f: Callable, name: str, args: Tuple, kwargs: Dict) -> Py5Promise']),
    (('Sketch', 'launch_repeating_thread'), ['(f: Callable, name: str, time_delay: float, args: Tuple, kwargs: Dict) -> str']),
    ...
    (('Sketch', 'save'), ['(filename: Union[str, Path], format: str, params) -> None']),
    ...
    (('Sketch', 'save_frame'), ['(filename: Union[str, Path], format: str, params) -> None']),
