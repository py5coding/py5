...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Py5Shape', 'get_param'), ['(index: int, /) -> float']),
    (('Py5Shape', 'get_params'), ['() -> NDArray[(Any,), Float]', '(target: NDArray[(Any,), Float], /) -> NDArray[(Any,), Float]']),
    ...
    (('Py5Shape', 'get_vertex_codes'), ['() -> JArray(JInt)']),
