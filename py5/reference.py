...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Sketch', 'random_choice'), ['(objects: list[Any], size: int=1, replace: bool=True) -> Any']),
    ...
    (('Py5Tools', 'save_frames'), ["(dirname: str, *, filename: str = 'frame_####.png', period: float = 0.0, start: int = None, limit: int = 0, sketch: Sketch = None, hook_post_draw: bool = False, block: bool = False) -> None"]),
