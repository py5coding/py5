...
METHOD_SIGNATURES_LOOKUP = dict([(('Sketch', 'alpha'), ['(rgb: int, /) -> float']),
    ...
    (('Sketch', 'bezier_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    ...
    (('Sketch', 'curve_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Sketch', 'day'), ['() -> int']),
    ...
    (('Sketch', 'lines'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    ...
    (('Sketch', 'points'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Sketch', 'pop'), ['() -> None']),
    ...
    (('Sketch', 'quadratic_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    ...
    (('Sketch', 'random_sample'), ['(objects: list[Any], size: int = 1, replace: bool = True) -> list[Any]']),
    ...
    (('Py5Shader', 'set'), ['(name: str, x: bool, /) -> None', '(name: str, x: bool, y: bool, /) -> None', '(name: str, x: bool, y: bool, z: bool, /) -> None', '(name: str, x: bool, y: bool, z: bool, w: bool, /) -> None', '(name: str, vec: JArray(JBoolean), /) -> None', '(name: str, boolvec: JArray(JBoolean), ncoords: int, /) -> None', '(name: str, x: float, /) -> None', '(name: str, x: float, y: float, /) -> None', '(name: str, x: float, y: float, z: float, /) -> None', '(name: str, x: float, y: float, z: float, w: float, /) -> None', '(name: str, vec: npt.NDArray[np.floating], /) -> None', '(name: str, vec: npt.NDArray[np.floating], ncoords: int, /) -> None', '(name: str, x: int, /) -> None', '(name: str, x: int, y: int, /) -> None', '(name: str, x: int, y: int, z: int, /) -> None', '(name: str, x: int, y: int, z: int, w: int, /) -> None', '(name: str, vec: npt.NDArray[np.integer], /) -> None', '(name: str, vec: npt.NDArray[np.integer], ncoords: int, /) -> None', '(name: str, tex: Py5Image, /) -> None', '(name: str, mat: npt.NDArray[np.floating], /) -> None', '(name: str, mat: npt.NDArray[np.floating], use3x3: bool, /) -> None', '(name: str, vec: Py5Vector, /) -> None']),
    ...
    (('Py5Shape', 'set_path'), ['(vcount: int, verts: npt.NDArray[np.floating], /) -> None']),
    ...
    (('Py5Graphics', 'mask'), ['(mask_array: npt.NDArray[np.integer], /) -> None', '(img: Py5Image, /) -> None']),
    ...
    (('Py5Graphics', 'lines'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Py5Graphics', 'vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Py5Graphics', 'bezier_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Py5Graphics', 'curve_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    (('Py5Graphics', 'quadratic_vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
    ...
    (('Py5Shape', 'set_strokes'), ['(strokes: npt.NDArray[np.int32], /) -> None']),
    (('Py5Shape', 'set_fills'), ['(fills: npt.NDArray[np.int32], /) -> None']),
    (('Py5Shape', 'vertices'), ['(coordinates: npt.NDArray[np.floating], /) -> None']),
