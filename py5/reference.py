...
METHOD_SIGNATURES_LOOKUP = dict([(('Sketch', 'alpha'), ['(rgb: int, /) -> float']),
    ...
    (('Sketch', 'begin_closed_shape'), ['() -> None', '(kind: int, /) -> None']),
    ...
    (('Sketch', 'convert_image'), ['(obj: Any, *, dst: Py5Image = None, **kwargs: dict[str, Any]) -> Py5Image']),
    (('Sketch', 'convert_cached_image'), ['(obj: Any, force_conversion: bool = False, **kwargs: dict[str, Any]) -> Py5Image']),
    (('Sketch', 'convert_shape'), ['(obj: Any, **kwargs: dict[str, Any]) -> Py5Shape']),
    (('Sketch', 'convert_cached_shape'), ['(obj: Any, force_conversion: bool = False, **kwargs: dict[str, Any]) -> Py5Shape']),
    ...
    (('Py5Shape', 'begin_closed_shape'), ['() -> None', '(kind: int, /) -> None']),
    ...
    (('Py5Graphics', 'begin_closed_shape'), ['() -> None', '(kind: int, /) -> None']),
