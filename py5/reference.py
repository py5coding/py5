...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Py5Vector', 'dist'), ['(other: Union[Py5Vector, np.ndarray]) -> Union[Py5Vector, np.ndarray[np.floating]]']),
    (('Py5Vector', 'dot'), ['(other: Union[Py5Vector, np.ndarray]) -> Union[float, np.ndarray[np.floating]]']),
    (('Py5Vector', 'angle_between'), ['(other: Union[Py5Vector, np.ndarray]) -> Union[Py5Vector, np.ndarray[np.floating]]']),
