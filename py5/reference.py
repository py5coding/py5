...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Sketch', 'noise'), ['(x: float, /) -> float', '(x: float, y: float, /) -> float', '(x: float, y: float, z: float, /) -> float']),
    (('Sketch', 'os_noise'), ['(x: float, y: float, /) -> float', '(x: float, y: float, z: float, /) -> float', '(x: float, y: float, z: float, w: float, /) -> float']),
    ...
    (('Py5Shader', 'set'), ['(name: str, x: bool, /) -> None', '(name: str, x: bool, y: bool, /) -> None', '(name: str, x: bool, y: bool, z: bool, /) -> None', '(name: str, x: bool, y: bool, z: bool, w: bool, /) -> None', '(name: str, vec: JArray(JBoolean), /) -> None', '(name: str, boolvec: JArray(JBoolean), ncoords: int, /) -> None', '(name: str, x: float, /) -> None', '(name: str, x: float, y: float, /) -> None', '(name: str, x: float, y: float, z: float, /) -> None', '(name: str, x: float, y: float, z: float, w: float, /) -> None', '(name: str, vec: NDArray[(Any,), Float], /) -> None', '(name: str, vec: NDArray[(Any,), Float], ncoords: int, /) -> None', '(name: str, x: int, /) -> None', '(name: str, x: int, y: int, /) -> None', '(name: str, x: int, y: int, z: int, /) -> None', '(name: str, x: int, y: int, z: int, w: int, /) -> None', '(name: str, vec: NDArray[(Any,), Int], /) -> None', '(name: str, vec: NDArray[(Any,), Int], ncoords: int, /) -> None', '(name: str, tex: Py5Image, /) -> None', '(name: str, mat: NDArray[(2, 3), Float], /) -> None', '(name: str, mat: NDArray[(4, 4), Float], /) -> None', '(name: str, mat: NDArray[(4, 4), Float], use3x3: bool, /) -> None', '(name: str, vec: Py5Vector, /) -> None']),
    ...
    (('Py5Vector', 'lerp'), ['(other: Union[Py5Vector, NDArray], amt: Union[float, NDArray]) -> Union[Py5Vector, NDArray]']),
    (('Py5Vector', 'dist'), ['(other: Union[Py5Vector, NDArray]) -> Union[Py5Vector, NDArray]']),
    (('Py5Vector', 'dot'), ['(other: Union[Py5Vector, NDArray]) -> Union[float, NDArray]']),
    (('Py5Vector', 'angle_between'), ['(other: Union[Py5Vector, NDArray]) -> Union[Py5Vector, NDArray]']),
    (('Py5Vector', 'cross'), ['(other: Union[Py5Vector, NDArray]) -> Union[float, Py5Vector, NDArray]']),
