...
METHOD_SIGNATURES_LOOKUP = dict([
    ...
    (('Py5Functions', 'render_frame_sequence'), ['(draw: Callable, width: int, height: int, renderer: str = Sketch.HIDDEN, *, limit: int = 1, setup: Callable = None, setup_args: tuple = None, setup_kwargs: dict = None, draw_args: tuple = None, draw_kwargs: dict = None, use_py5graphics: bool = False) -> list[PIL.ImageFile.ImageFile]']),
    (('Py5Functions', 'render_sequence'), ['(width: int, height: int, renderer: str = Sketch.HIDDEN, *, limit: int = 1, setup: Callable = None, setup_args: tuple = None, setup_kwargs: dict = None, use_py5graphics: bool = False) -> list[PIL.ImageFile.ImageFile]']),
    ...
    (('Py5Tools', 'capture_frames'), ['(count: float, *, period: float = 0.0, sketch: Sketch = None, hook_post_draw: bool = False, block: bool = False) -> list[PIL.Image]']),
