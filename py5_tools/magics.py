...
class Py5Magics(Magics):
    ...
    @argument('--filename', type=str, dest='filename',
    ...
    @argument('delay', type=int,
              help='time in milliseconds between Sketch snapshots')
    @argument('duration', type=int,
              help='time in milliseconds between frames in the GIF')
    @argument('-w', type=int, dest='wait', default=0,
              help='wait time in seconds before starting sketch frame capture')
